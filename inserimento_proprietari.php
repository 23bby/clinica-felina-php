...
$sql = "INSERT INTO padroni (nome_padrone, cognome_padrone, telefono_padrone, email_padrone) VALUES (:nome_padrone, :cognome_padrone, 
:telefono_padrone, :email_padrone)";
...
header("Location: form_proprietari_ins.php");
